...
var dataG = `random data`

var publicKeyG = `RWRQmBOLeYzAeuR2L6L1GJN9qTR8ceQrawtijPTQkVbf3LJsrLeUjQcL`

var signG = `untrusted comment: signature from minisign secret key
