...
RUN curl --create-dirs -L https://raw.githubusercontent.com/grpc-ecosystem/grpc-gateway/v${GRPC_GW_VERSION}/third_party/googleapis/google/api/annotations.proto -o /usr/local/include/google/api/annotations.proto
RUN curl --create-dirs -L https://raw.githubusercontent.com/grpc-ecosystem/grpc-gateway/v${GRPC_GW_VERSION}/third_party/googleapis/google/api/http.proto -o /usr/local/include/google/api/http.proto
RUN curl --create-dirs -L https://raw.githubusercontent.com/grpc-ecosystem/grpc-gateway/v${GRPC_GW_VERSION}/third_party/googleapis/google/rpc/status.proto -o /usr/local/include/google/rpc/status.proto
RUN go clean -cache
