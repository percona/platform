...
var file_utils_fsp_fsp_proto_rawDesc = string([]byte{
...
func file_utils_fsp_fsp_proto_rawDescGZIP() []byte {
	file_utils_fsp_fsp_proto_rawDescOnce.Do(func() {
		file_utils_fsp_fsp_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_utils_fsp_fsp_proto_rawDescData)))
	})
	return []byte(file_utils_fsp_fsp_proto_rawDescData)
}
