...
const (
	ReporterAPI_Report_FullMethodName      = "/percona.platform.telemetry.reporter.v1.ReporterAPI/Report"
	ReporterAPI_SearchEvent_FullMethodName = "/percona.platform.telemetry.reporter.v1.ReporterAPI/SearchEvent"
)
...
func (c *reporterAPIClient) SearchEvent(ctx context.Context, in *SearchEventRequest, opts ...grpc.CallOption) (*SearchEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReporterAPI_SearchEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterReporterAPIServer(s grpc.ServiceRegistrar, srv ReporterAPIServer) {
	// If the following call panics, it indicates UnimplementedReporterAPIServer was
...
func _ReporterAPI_SearchEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReporterAPI_SearchEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
