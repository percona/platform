...
import (
	...
	pmm "github.com/percona/platform/gen/telemetry/events/pmm"
...
var file_telemetry_reporter_reporter_api_proto_rawDesc = []byte{
	...
	0x73, 0x3a, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x42, 0xbe, 0x03, 0x92, 0x41, 0x80, 0x01, 0x12,
	...
	0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x65, 0x72, 0x63,
...
func file_telemetry_reporter_reporter_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_telemetry_reporter_reporter_api_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_telemetry_reporter_reporter_api_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_telemetry_reporter_reporter_api_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_telemetry_reporter_reporter_api_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_telemetry_reporter_reporter_api_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_telemetry_reporter_reporter_api_proto_msgTypes[5].Exporter = func(v any, i int) any {
