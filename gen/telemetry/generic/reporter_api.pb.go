...
func file_telemetry_generic_reporter_api_proto_rawDescGZIP() []byte {
	file_telemetry_generic_reporter_api_proto_rawDescOnce.Do(func() {
		file_telemetry_generic_reporter_api_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_telemetry_generic_reporter_api_proto_rawDescData)))
	})
	return []byte(file_telemetry_generic_reporter_api_proto_rawDescData)
}
