...
// UnimplementedOrgAPIServer must be embedded to have
...
func (UnimplementedOrgAPIServer) testEmbeddedByValue()                {}
...
func RegisterOrgAPIServer(s grpc.ServiceRegistrar, srv OrgAPIServer) {
	// If the following call pancis, it indicates UnimplementedOrgAPIServer was
