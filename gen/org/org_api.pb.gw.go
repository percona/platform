...
var pattern_OrgAPI_CreateOrganization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"org", "v1", "OrgAPI", "Create"}, "", runtime.AssumeColonVerbOpt(true)))

var forward_OrgAPI_CreateOrganization_0 = runtime.ForwardResponseMessage
