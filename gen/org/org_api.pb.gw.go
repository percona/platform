...
var (
	pattern_OrgAPI_CreateOrganization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "org", "CreateOrganization"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_OrgAPI_GetOrganization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "org", "GetOrganization"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_OrgAPI_DeleteOrganization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "org", "DeleteOrganization"}, "", runtime.AssumeColonVerbOpt(true)))
)
