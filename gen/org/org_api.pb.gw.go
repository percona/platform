...
func request_OrgAPI_SearchKnowledgeBase_0(ctx context.Context, marshaler runtime.Marshaler, client OrgAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SearchKnowledgeBaseRequest
	var metadata runtime.ServerMetadata
...
func local_request_OrgAPI_SearchKnowledgeBase_0(ctx context.Context, marshaler runtime.Marshaler, server OrgAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SearchKnowledgeBaseRequest
	var metadata runtime.ServerMetadata
...
func RegisterOrgAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OrgAPIServer) error {
	...
	mux.Handle("POST", pattern_OrgAPI_SearchKnowledgeBase_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_OrgAPI_SearchKnowledgeBase_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_OrgAPI_SearchKnowledgeBase_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterOrgAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OrgAPIClient) error {
	...
	mux.Handle("POST", pattern_OrgAPI_SearchKnowledgeBase_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_OrgAPI_SearchKnowledgeBase_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_OrgAPI_GetOrganization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "orgs", "id"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_OrgAPI_DeleteOrganization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "orgs", "id"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_OrgAPI_SearchKnowledgeBase_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "orgs", "knowledgebase"}, "search", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_OrgAPI_SearchKnowledgeBase_0 = runtime.ForwardResponseMessage
)
