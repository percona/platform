...
func RegisterOrgAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OrgAPIServer) error {
	...
	mux.Handle("GET", pattern_OrgAPI_ListMembers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
var (
	...
	pattern_OrgAPI_InviteMember_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "orgs", "id", "members"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_OrgAPI_ListMembers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "orgs", "id", "members"}, "", runtime.AssumeColonVerbOpt(true)))
)
