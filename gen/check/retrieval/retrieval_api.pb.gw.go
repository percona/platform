...
var (
	pattern_RetrievalAPI_GetAllChecks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"check", "retrieval", "v1", "RetrievalAPI", "GetAllChecks"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_RetrievalAPI_GetAllAlertRuleTemplates_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"check", "retrieval", "v1", "RetrievalAPI", "GetAllAlertRuleTemplates"}, "", runtime.AssumeColonVerbOpt(true)))
)
