...
/*
Package retrievalv1 is a reverse proxy.
...
func request_RetrievalAPI_UpdateAdvisorsStatus_0(ctx context.Context, marshaler runtime.Marshaler, client RetrievalAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateAdvisorsStatusRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateAdvisorsStatus(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_RetrievalAPI_UpdateAdvisorsStatus_0(ctx context.Context, marshaler runtime.Marshaler, server RetrievalAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateAdvisorsStatusRequest
	var metadata runtime.ServerMetadata
...
func RegisterRetrievalAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RetrievalAPIServer) error {
	...
	mux.Handle("POST", pattern_RetrievalAPI_GetAllChecks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_RetrievalAPI_GetAllChecks_0(annotatedContext, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("POST", pattern_RetrievalAPI_GetAllAdvisors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_RetrievalAPI_GetAllAdvisors_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("POST", pattern_RetrievalAPI_GetAllAlertRuleTemplates_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_RetrievalAPI_GetAllAlertRuleTemplates_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("POST", pattern_RetrievalAPI_UpdateAdvisorsStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/percona.platform.check.retrieval.v1.RetrievalAPI/UpdateAdvisorsStatus", runtime.WithHTTPPathPattern("/v1/check/checks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_RetrievalAPI_UpdateAdvisorsStatus_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_RetrievalAPI_UpdateAdvisorsStatus_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterRetrievalAPIHandlerFromEndpoint is same as RegisterRetrievalAPIHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterRetrievalAPIHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
...
// RegisterRetrievalAPIHandler registers the http handlers for service RetrievalAPI to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterRetrievalAPIHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterRetrievalAPIHandlerClient(ctx, mux, NewRetrievalAPIClient(conn))
}

// RegisterRetrievalAPIHandlerClient registers the http handlers for service RetrievalAPI
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "RetrievalAPIClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "RetrievalAPIClient"
...
func RegisterRetrievalAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RetrievalAPIClient) error {
	...
	mux.Handle("POST", pattern_RetrievalAPI_GetAllChecks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_RetrievalAPI_GetAllChecks_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_RetrievalAPI_GetAllAdvisors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_RetrievalAPI_GetAllAdvisors_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_RetrievalAPI_GetAllAlertRuleTemplates_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_RetrievalAPI_GetAllAlertRuleTemplates_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_RetrievalAPI_UpdateAdvisorsStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/percona.platform.check.retrieval.v1.RetrievalAPI/UpdateAdvisorsStatus", runtime.WithHTTPPathPattern("/v1/check/checks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_RetrievalAPI_UpdateAdvisorsStatus_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_RetrievalAPI_UpdateAdvisorsStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "check", "checks"}, ""))
)
...
var (
	...
	forward_RetrievalAPI_UpdateAdvisorsStatus_0 = runtime.ForwardResponseMessage
)
