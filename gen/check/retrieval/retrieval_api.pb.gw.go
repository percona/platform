...
func RegisterRetrievalAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RetrievalAPIServer) error {
	...
	mux.Handle("POST", pattern_RetrievalAPI_GetAllAdvisors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/percona.platform.check.retrieval.v1.RetrievalAPI/GetAllAdvisors", runtime.WithHTTPPathPattern("/v1/check/GetAllAdvisors"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_RetrievalAPI_GetAllAdvisors_0(ctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_RetrievalAPI_GetAllAdvisors_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterRetrievalAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RetrievalAPIClient) error {
	...
	mux.Handle("POST", pattern_RetrievalAPI_GetAllAdvisors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/percona.platform.check.retrieval.v1.RetrievalAPI/GetAllAdvisors", runtime.WithHTTPPathPattern("/v1/check/GetAllAdvisors"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_RetrievalAPI_GetAllAdvisors_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
