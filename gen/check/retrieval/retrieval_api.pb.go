...
func file_check_retrieval_retrieval_api_proto_rawDescGZIP() []byte {
	file_check_retrieval_retrieval_api_proto_rawDescOnce.Do(func() {
		file_check_retrieval_retrieval_api_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_check_retrieval_retrieval_api_proto_rawDescData)))
	})
	return []byte(file_check_retrieval_retrieval_api_proto_rawDescData)
}
