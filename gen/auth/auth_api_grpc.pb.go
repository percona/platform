...
const (
	AuthAPI_SignUp_FullMethodName            = "/percona.platform.auth.v1.AuthAPI/SignUp"
	AuthAPI_SignIn_FullMethodName            = "/percona.platform.auth.v1.AuthAPI/SignIn"
	AuthAPI_SignOut_FullMethodName           = "/percona.platform.auth.v1.AuthAPI/SignOut"
	AuthAPI_RefreshSession_FullMethodName    = "/percona.platform.auth.v1.AuthAPI/RefreshSession"
	AuthAPI_ResetPassword_FullMethodName     = "/percona.platform.auth.v1.AuthAPI/ResetPassword"
	AuthAPI_GetProfile_FullMethodName        = "/percona.platform.auth.v1.AuthAPI/GetProfile"
	AuthAPI_SearchUserProfile_FullMethodName = "/percona.platform.auth.v1.AuthAPI/SearchUserProfile"
	AuthAPI_UpdateProfile_FullMethodName     = "/percona.platform.auth.v1.AuthAPI/UpdateProfile"
	AuthAPI_ActivateProfile_FullMethodName   = "/percona.platform.auth.v1.AuthAPI/ActivateProfile"
	AuthAPI_ValidateToken_FullMethodName     = "/percona.platform.auth.v1.AuthAPI/ValidateToken"
)
...
func (c *authAPIClient) SignUp(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*SignUpResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_SignUp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authAPIClient) SignIn(ctx context.Context, in *SignInRequest, opts ...grpc.CallOption) (*SignInResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_SignIn_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authAPIClient) SignOut(ctx context.Context, in *SignOutRequest, opts ...grpc.CallOption) (*SignOutResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_SignOut_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authAPIClient) RefreshSession(ctx context.Context, in *RefreshSessionRequest, opts ...grpc.CallOption) (*RefreshSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_RefreshSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authAPIClient) ResetPassword(ctx context.Context, in *ResetPasswordRequest, opts ...grpc.CallOption) (*ResetPasswordResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_ResetPassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authAPIClient) SearchUserProfile(ctx context.Context, in *SearchUserProfileRequest, opts ...grpc.CallOption) (*SearchUserProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_SearchUserProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authAPIClient) UpdateProfile(ctx context.Context, in *UpdateProfileRequest, opts ...grpc.CallOption) (*UpdateProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_UpdateProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authAPIClient) ActivateProfile(ctx context.Context, in *ActivateProfileRequest, opts ...grpc.CallOption) (*ActivateProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_ActivateProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthAPI_RefreshSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthAPI_RefreshSession_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthAPI_ResetPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthAPI_ResetPassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthAPI_SearchUserProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthAPI_SearchUserProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthAPI_UpdateProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthAPI_UpdateProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthAPI_ActivateProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthAPI_ActivateProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
